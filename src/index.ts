...
export class QuestradeClass extends EE {
  ...
  // public emit(arg0: any, arg1?: any): any {
  ...
  //     //
  //   };
  //   public testStrategy =  (opts: any, cb: any) => {
  //     this.accountApi('POST', '/orders/strategy/impact', opts, cb);
  //   };
  //   public updateOrder = () => {
  //     //
  //   };
  ...
  public setPrimaryAccount = (cb: any) => {
    this.getAccounts(
  ...
  public getPositions = (cb: any) => {
    this._accountApi('GET', '/positions', cb);
  };

  public getBalances = (cb: any) => {
    this._accountApi('GET', '/balances', cb);
  };

  public getExecutions = (cb: any) => {
    this._accountApi('GET', '/executions', cb);
  };

  public getOrder = (id: any, cb: any) => {
  ...
  public getOrders = (ids: any, cb: any) => {
  ...
  public getSymbol = (id: any, cb: any) => {
  ...
  public getSymbols = (ids: any, cb: any) => {
    if (!Array.isArray(ids)) {
      return cb({
        message: 'missing_ids',
      });
  ...
  public getOptionChain = (symbolId: any, cb: any) => {
    this._api(
      'GET',
  ...
  public getQuotes = (ids: any, cb: any) => {
    if (!Array.isArray(ids)) {
      return cb({
        message: 'missing_ids',
      });
  ...
  public getOptionQuote = (filters_: any[], cb: any) => {
  ...
  public getOptionQuoteSimplified = (filters: any, cb: any) => {
  ...
  public createOrder = (opts: any, cb: any) => {
    this._accountApi('POST', '/orders', opts, cb);
  };

  public updateOrder = (id: string, opts: any, cb: any) => {
    this._accountApi('POST', `/orders/${id}`, opts, cb);
  };

  public testOrder = (opts: any, cb: any) => {
    this._accountApi('POST', '/orders/impact', opts, cb);
  };

  public removeOrder = (id: string, cb: any) => {
    this._accountApi('DELETE', `/orders/${id}`, cb);
  };

  public createStrategy = (opts: any, cb: any) => {
